...
class EchoServiceTest {
  ...
  static void setUp() throws IOException {
    ...
    Dispatcher clouddriverDispatcher = new Dispatcher() {
      @Override
    ...
    Dispatcher front50Dispatcher = new Dispatcher() {
      @Override
      public MockResponse dispatch(RecordedRequest request) {
        return new MockResponse().setResponseCode(200);
      }
  ...
  void shouldNotOrderTheKeysWhenCallingEcho() throws InterruptedException {
    ...
    assertThat(requestBody).isEqualTo("{\"ref\":\"refs/heads/main\",\"before\":\"ca7376e4b730f1f2878760abaeaed6c039fc5414\",\"after\":\"c2420ce6e341ef0042f2e12591bdbe9eec29a032\",\"id\":105648914}");
