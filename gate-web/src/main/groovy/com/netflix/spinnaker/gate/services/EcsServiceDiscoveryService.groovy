...
@Component
class EcsServiceDiscoveryService {
  private static final String GROUP = "ecsServiceDiscoveryService"

  ClouddriverService clouddriver

  @Autowired
  EcsServiceDiscoveryService(ClouddriverService clouddriver) {
    this.clouddriver = clouddriver
  }

  List getAllEcsServiceDiscoveryRegistries() {
    HystrixFactory.newListCommand(GROUP, "getAllEcsServiceDiscoveryRegistries") {
