...
class EcsClusterController {
  ...
  @ApiOperation(value = "Retrieve a list Ecs Cluster Description WRT account and region")
  @RequestMapping(value = "/ecs/getEcsClusterDescriptions/{account}/{region}", method = RequestMethod.GET)
